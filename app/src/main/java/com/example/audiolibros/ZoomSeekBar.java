...
/**
 * Created by usuwi on 09/01/2017.
 */
...
public class ZoomSeekBar extends View {
    ...
    private int escalaRaya = 2;  //cada cuantas unidades una raya
    private int escalaRayaLarga = 5; //cada cuantas rayas un larga
    ...
    //Declaramos variable escuchador para val
    ...
    public ZoomSeekBar(Context context, AttributeSet attrs) {
      ...
      /* val.setOnValChangeListener(new OnValChangeListener(){
            @Override
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //yIni = getPaddingTop();
        //Centramos verticalmente la vista
        int altoView = getPaddingTop() + altoBar + altoRegla + altoNumeros + getPaddingBottom();
        yIni = h / 2 - altoView / 2;
    ...
    public void setVal(int val) {
        //Verificamos que se esté poniendo un valor dentro del rango permitido
    ...
    public void setValMin(int valMin) {
        //Verificamos que el valor mínimo sea menor que el valor seleccionado
        if (valMin <= val) {
            this.valMin = valMin;
    ...
    public void setValMax(int valMax) {
        //verificamos que el valor máximo sea mayor que el valor seleccionado
        if (valMax >= val) {
            this.valMax = valMax;
    ...
    public void setEscalaMin(int escalaMin) {
        //verificamos que el valor mínimo visualizado es mayor que el valor mínimo
        if(escalaMin>=valMin){
            this.escalaMin = Math.min(valMin,val);
    ...
    public void setEscalaMax(int escalaMax) {
        //verificamos que el valor máximo visualizado es menor que el valor máximo
        if( escalaMax<= valMax){
    ...
    //Creamos el escuchador de eventos en ZoomSeekBar
    public interface OnValChangeListener {
        void onValChangeListener(int val);
    }
